...
#SBATCH --gpus=1
#SBATCH --job-name=combined-text-schema-bart
#SBATCH --time=24:0:0
...
OUTPUT_DIR="/brtx/603-nvme1/wgantt/SEAMuS-experiments/$TASK-$FORMAT-$RETRIEVAL_SETTING-bart-$SEED"

# These retrieved contexts are used in place of
# the full, original source documents
SRC_OVERRIDE_DIR="/brtx/603-nvme1/wgantt/SEAMuS/seamus/resources/saved_contexts/"
